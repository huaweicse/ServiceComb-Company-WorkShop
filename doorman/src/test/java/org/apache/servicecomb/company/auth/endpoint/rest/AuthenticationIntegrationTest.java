...
import static org.apache.servicecomb.company.auth.endpoint.rest.AuthorizationHeaderGenerator.TOKEN_PREFIX;
...
import org.apache.servicecomb.company.DoormanApplication;
...
public class AuthenticationIntegrationTest {
  ...
  public void forbidsAccessOfInvalidUser() throws Exception {
    mockMvc.perform(
        post("/rest/login")
            .contentType(APPLICATION_FORM_URLENCODED)
            .param(AuthenticationController.USERNAME, uniquify("invalid-user"))
            .param(AuthenticationController.PASSWORD, uniquify("password")))
