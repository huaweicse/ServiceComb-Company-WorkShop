...
kubectl delete hpa zipkin
kubectl delete hpa company-bulletin-board 
kubectl delete hpa company-worker 
kubectl delete hpa company-doorman 
kubectl delete hpa company-beekeeper 
kubectl delete hpa company-manager 
