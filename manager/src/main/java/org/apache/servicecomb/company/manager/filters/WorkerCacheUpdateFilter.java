...
import static org.apache.servicecomb.company.manager.filters.FilterConstants.FIBONACCI_PATH;
...
class WorkerCacheUpdateFilter extends CacheUpdateFilter {
  ...
  @Autowired
  WorkerCacheUpdateFilter(ProjectArchive<String, String> archive, PathExtractor pathExtractor) {
